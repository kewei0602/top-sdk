...
class SubPurchaseOrder
{
	...
	/** 
	 * Feature对象列表目前已有的属性：attr_key为 www，attr_value为1 表示是www子订单attr_key为 wwwStoreCode，attr_value 是www子订单发货的仓库编码attr_key为isWt,attr_value为1 表示是网厅子订单attr_key为wtInfo,attr_value为网厅相关合约信息;attr_key为shipper,attr_value为cn表示菜鸟发货
	 **/
	public $features;
